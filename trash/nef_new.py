...
class nef(BaseNeuralField):
    ...
    def __init__(self,
        ...
        self.decoder_density = BasicDecoder(input_dim=self.density_net_input_dim(),
                                       ...
                                       skip=[])
        self.decoder_density.lout.bias.data[0] = 1
    ...
    def register_forward_functions(self):
        ...
        """
        self._register_forward_function(self.sample, ["rgb", "density", "density_feats"])
    ...
    def sample(self, coords, ray_d, idx=None, lod_idx=None):
        ...
        return dict(rgb=colors, density=density, density_feats=density_feats)


    def sample_t(self, coords, ray_d, density_feats, idx=None, lod_idx=None):
        """Compute color and density [particles / vol] for the provided coordinates.
        ...
        feats_t = torch.cat([feats_t, density_feats], dim=-1)
    ...
    def transient_net_input_dim(self):
        ...
        #return self.effective_feature_dim(self.grid_t[0]) + self.pos_embed_dim
